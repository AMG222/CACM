/*
 * Soluci�n al problema de los n�meros de Erd�s.
 * Implementaci�n con listas en base al template vector.
 *
 * Se trabaja con una lista de art�culos (lista de objetos de la clase paper),
 * y dentro de cada art�culo figura la lista de autores.
 */
...
int main( int argc, char *argv[] )
{
	...
	for( int caso=0; caso < num_casos; caso++ ) {
		...
		// ##########################################################
		// AQU� DEBE IR EL ALGORITMO QUE OBTIENE LA SOLUCI�N
		//erdos [0,1,2,3]
		//autor [1,2,3,4]
		cout << contador_erdos[autores[nombre_de_erdos]] <<endl;
